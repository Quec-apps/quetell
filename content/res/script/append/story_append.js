$("body").prepend(`
<img src="../../../res/icons/back.png" class="back-img">
<div class="top">
<div class="poster-bg">
...
<div class="mid">
<div class="button like"><img src="../../../res/icons/not_like.png" alt="like" class="mid-img like-img"><span id="like-txt">${localStorage.getItem("liked")}K</span></div>
